        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" @click="resetActivateDeactivatePublicKeysModal" 
                ...
                <div class="modal-body">
                    ...
                    <form ref="form" id="editKeyForm" class="modal-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" 
                        @click="resetActivateDeactivatePublicKeysModal" data-dismiss="modal">Cancel</button>
                    <button type="button" :disabled="buttonSubmitDisabled" 
                        @click="onSubmitEditPublicKey" class="btn btn-primary">
                        Save &nbsp;&nbsp;   
