        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" @click="resetActivateDeactivateMeterModal" 
                ...
                <div class="modal-body">
                    ...
                    <form ref="form" id="activateDeactivateMeterForm" class="modal-form">
...
<script>
export default {
    name: "ActivateDeactivateMeterComponent",
    props: [
        'meter'
    ],
    data() {
    ...
    methods: {
        ...
        onSubmitEditMeter: function(event) {
            let self = this
            self.errors = []
                let formData = new FormData(document.getElementById("activateDeactivateMeterForm"))
                self.saveSpinner = true
                self.buttonSubmitDisabled = true
                axios.post('/subscriberMeters/' + self.meter.ref + '/activateDeactivate', formData).then(function(response, status, request) {  
